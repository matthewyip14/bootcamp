...
public class DemoQueue {
  public static void main(String[] args) {
    ...
    fruits.add("orange");
    fruits.add("lemon");
    System.out.println(fruits.poll()); // apple (take away the frist element from the queue)
    ...
    // 1. queue has less method to use (specific usage), while list is more general for more scenaario.
