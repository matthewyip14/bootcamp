...
public class DemoArrayList {
  public static void main(String[] args) {
    ...
    // but Java follow Polymorphism, the allowed methods refer to the type of object reference.
    ...
    System.out.println(names.getFirst()); // John, because ArrayList is ordering
    System.out.println(names.getLast()); // Jennie
    System.out.println(names.get(1)); // John

    List<String> reversed = names.reversed();
    System.out.println(reversed); // [Jennie, John]

    String reversed.set(1, "Steve");
